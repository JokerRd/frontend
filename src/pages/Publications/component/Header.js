		...
		<header className="d-flex flex-wrap align-items-center justify-content-between py-3">
			...
			<div className="nav col-auto justify-content-center mb-md-0">
				<ul className="nav nav-pills">
					...
					<li className="nav-item"><a href="https://localhost:3000/builderPost" className="nav-link">Создать публикацию</a></li>
					<li className="nav-item"><a href="https://localhost:3000/publications" className="nav-link active">Мои публикации</a></li>
				</ul>
			</div>
